...
set xtics format ""
set xrange [0:2000.00000000] writeback
...
shell0 = "sed -i -e \"s/input{.*}/input{pT-jet-50GeV.tex}/\" tot.tex "
shell1 = "dvipdf tot.dvi pT-jet-50GeV.pdf"
shell2 = "pdfcrop pT-jet-50GeV.pdf"
shell3 = "dvips -E tot.dvi -o tot.eps"
shell4 = "mv pT-jet-50GeV-crop.pdf pT-jet-50GeV.pdf"
shell5 = "mv tot.eps pT-jet-50GeV.eps"
system shell0
set output
