...
c rhoweight = B1/(B1+B2) - used to calculate rho in Born.f and gen_index
     ...
     8     rad_tot,rad_etot,rhoweight,rhorweight(6),Bfact,ggbornplanar1,ggbornplanar2
...
c Current event weight, needed when doing reweghting    
     ...
     4     rad_branching,rad_currentweight,rhoweight,rhorweight,Bfact,ggbornplanar1,ggbornplanar2,
c     integers
